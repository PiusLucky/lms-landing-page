...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-10 w-max items-center justify-center rounded-md  py-2 text-sm font-medium transition-colors  dark:data-[state=open]:text-slate-50 dark:data-[state=open]:bg-slate-800/50 dark:data-[state=open]:hover:bg-slate-800 dark:data-[state=open]:focus:bg-slate-800"
);
